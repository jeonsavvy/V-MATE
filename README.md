...
즉, **캐릭터는 반응 방식의 축**, **월드는 장면 규칙의 축**, **브리지는 두 축을 현재 방의 시작 문맥으로 정리하는 축**입니다.
...
월드의 장르가 `game` 계열이면 브리지 생성 단계에서 전투/레이드 직전 장면에 맞는 기본 역할과 압력을 잡습니다.
